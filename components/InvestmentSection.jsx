    ...
    <section className="mx-auto grid max-w-7xl gap-12 px-4 py-16 md:px-6 lg:grid-cols-2">
      <div className="relative">
        ...
        <img
          ...
          className="relative h-105 w-full rounded-[28px] object-cover shadow-lg"
        />
      </div>
      ...
      <div className="flex flex-col justify-center">
        ...
        <p className="mt-5 text-lg leading-9 text-slate-600">
          GUB Bank helps users achieve their financial goals by helping them
          save and invest with ease. Put that extra cash to use without putting
          it at risk.
        </p>
