    ...
    <section className="mx-auto max-w-7xl px-4 py-16 md:px-6">
      <div className="mb-10">
        ...
        <h3 className="mt-3 text-4xl font-bold leading-tight md:text-5xl">
          Access Endless Possibilities with{" "}
          <span className="text-blue-600">GUB Bank Card</span>
        </h3>
        <p className="mt-5 max-w-3xl text-lg leading-8 text-slate-600">
          All your needs covered with a full range of credit and debit cards
          designed for convenience, rewards, and security.
        </p>
      </div>
        ...
        {benefitCards.map((item) => {
          ...
          return (
            ...
            >
              ...
              <h4 className="mt-6 text-3xl font-bold text-blue-700">
                {item.title}
              </h4>
