    ...
    <section className="bg-[#eef4fb] py-16">
      <div className="mx-auto max-w-5xl px-4 md:px-6">
        <div className="text-center">
          ...
          <h3 className="mt-3 text-5xl font-bold leading-tight">
          ...
          {faqs.map((item, index) => (
            <div key={item.q} className="rounded-[28px] bg-white p-8 shadow-sm">
              ...
              >
                ...
                <span className="flex h-12 w-12 items-center justify-center rounded-xl bg-slate-100 text-3xl text-blue-600">
                  {openFaq === index ? "−" : "+"}
                </span>
              </button>
