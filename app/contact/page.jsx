      ...
      <div className="mx-auto grid max-w-7xl gap-8 px-4 md:px-6 lg:grid-cols-2">
        <div className="rounded-[28px] bg-white p-8 shadow-sm">
          ...
          <p className="mt-4 text-lg leading-8 text-slate-600">
            Have a question about accounts, remittance, or digital banking? Our
            team is here to help.
          </p>

          <div className="mt-8 space-y-5 text-lg text-slate-700">
            <p>
              <strong>Address:</strong> Purbachal American City, Kanchan,
              Rupganj, Narayanganj-1461, Dhaka, Bangladesh
            </p>
            <p>
              <strong>Phone:</strong> +880 1921-349424
            </p>
            <p>
              <strong>Email:</strong> support@gubbank.com
            </p>
            <p>
              <strong>Hours:</strong> Sunday - Thursday, 9 AM - 5 PM
            </p>
          </div>
        </div>
